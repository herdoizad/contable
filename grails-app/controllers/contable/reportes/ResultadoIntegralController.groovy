...
class ResultadoIntegralController extends Shield {
    ...
    def reporte(){
        ...
        qrCodeService.renderPng(reportesService.getVcardReporte(session.usuario.login,"Resultado integral"), 70, bs)
        ...
        writer.setPageEvent(new contable.HeaderFooter(img.readBytes(),bs, fecha, session.usuario.login,", Resultado integral",null));
