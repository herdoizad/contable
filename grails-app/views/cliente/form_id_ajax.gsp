...
<div class="modal-contenido">
    <g:form class="form-horizontal" name="frmCliente" id="${clienteInstance?.codigo}"
            role="form" controller="cliente" action="save_id_ajax" method="POST">
        <div class="row fila" >
        ...
        <div class="row fila">
            ...
            <div class="col-md-4">
                <g:textField name="nombre" maxlength="50" class="form-control input-sm required " value="${clienteInstance?.nombre?.trim()}"/>
            </div>
            <div class="col-md-1 text-right">
                <label>Ciudad</label>
            </div>
        ...
        <div class="row fila">
            ...
            <div class="col-md-4">
                <g:textField name="cp" maxlength="50" class="form-control  input-sm required" value="${clienteInstance?.cp?.trim()}"/>
            </div>
            <div class="col-md-1 text-right">
