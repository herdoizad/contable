                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <g:sortableColumn property="auxiliar2" title="Auxiliar2" />
                        ...
                        <g:if test="${clienteInstanceCount > 0}">
                            <g:each in="${clienteInstanceList}" status="i" var="clienteInstance">
                                <tr data-id="${clienteInstance.codigo}">
                                    ...
                                    <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${clienteInstance}" field="auxiliar"/></elm:textoBusqueda></td>

                                    <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${clienteInstance}" field="auxiliar2"/></elm:textoBusqueda></td>
