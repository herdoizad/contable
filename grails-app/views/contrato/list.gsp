                        ...
                        <div class="btn-group pull-right col-md-8">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <g:link controller="contrato" action="list" class="btn btn-default btn-search btn-sm">
                ...
                <g:if test="${contratoInstanceCount > 0}">
                    <g:each in="${contratoInstanceList}" status="i" var="contratoInstance">
                        <tr data-id="${contratoInstance.id}">
                            ...
                            <td>${contratoInstance.numero}</td>
                            
                            <td><g:formatDate date="${contratoInstance.fin}" format="dd-MM-yyyy" /></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${contratoInstance}" field="path"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${contratoInstance}" field="empleado"/></elm:textoBusqueda></td>
                            
                            <td><g:formatDate date="${contratoInstance.inicio}" format="dd-MM-yyyy" /></td>
                            
                            <td><g:fieldValue bean="${contratoInstance}" field="sueldo"/></td>
