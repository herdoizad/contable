		...
		<div id="list-estadoCivil" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'estadoCivil.codigo.label', default: 'Codigo')}" />
				...
				<g:each in="${estadoCivilInstanceList}" status="i" var="estadoCivilInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estadoCivilInstance.id}">${fieldValue(bean: estadoCivilInstance, field: "codigo")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${estadoCivilInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
