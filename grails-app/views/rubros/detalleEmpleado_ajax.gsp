<div class="row fila">
    ...
    <div class="col-md-3">
        <g:select name="rubros" id="rubros" from="${contable.nomina.Rubro.findAllByVariableIsNullAndEstadoIsNull([sort: 'nombre'])}" optionKey="id" optionValue="nombre" class="form-control input-sm"/>
    </div>
