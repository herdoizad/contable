<%@ page import="contable.seguridad.Modulo; contable.seguridad.Permiso; contable.seguridad.Permiso; contable.seguridad.Modulo; contable.seguridad.TipoAccion" %>
...
<table id="tblAcciones" class="table table-bordered table-condensed table-hover">
    ...
    <tbody>
        <g:each in="${acciones}" var="accion" status="i">
            ...
            <g:set var="cantPermisos" value="${Permiso.countByAccionAndUsuario(accion, usuario)}"/>
