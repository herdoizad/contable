...
<g:form name="frm" class="frm-comprobante" action="saveEgreso" controller="comprobantes">
    ...
    <div class="row fila">
        ...
        <div class="col-md-2">
            <g:select name="tipoEgreso" id="modo" from="${tipos}" optionKey="key" optionValue="value" class="form-control input-sm"/>
        </div>
        <div class="col-md-1">
            <label>Fecha:</label>
        </div>
    ...
    <div class="row fila">
        ...
        <div class="col-md-5" >
            <g:select name="cheque.cliente" id="cliente" from="${clientes}"  noSelection="['':'']"
                      class="form-control input-sm select"    optionKey="codigo" optionValue="cp"/>
        </div>
    ...
    <div class="row fila">
        ...
        <div class="col-md-1" >
            <input type="text" class="form-control input-sm" id="cuenta_cheque" readonly>
        </div>
        <div class="col-md-1" >
            <label>Cheque:</label>
        </div>
        <div class="col-md-1">
            <input type="text" name="cheque.numero" class="form-control input-sm" id="cheque_cheque" readonly>
        </div>
        <div class="col-md-2">
            <elm:datepicker name="chequefecha" class="form-control input-sm" minDate="${inicio}" maxDate="${fin}" value="${inicio}"></elm:datepicker>
        </div>
        <div class="col-md-1">
            <label>Valor:</label>
        </div>
        <div class="col-md-2">
            <input type="text" name="cheque.valor" id="valor_cheque" class="form-control input-sm num number" >
        </div>
    </div>
</g:form>
