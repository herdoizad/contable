...
<html>
	...
	<body>
		<a href="#show-tipoContrato" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-tipoContrato" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoContrato">
				...
				<li class="fieldcontain">
					<span id="codigo-label" class="property-label"><g:message code="tipoContrato.codigo.label" default="Codigo" /></span>
					
						<span class="property-value" aria-labelledby="codigo-label"><g:fieldValue bean="${tipoContratoInstance}" field="codigo"/></span>
				...
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="tipoContrato.descripcion.label" default="Descripcion" /></span>
			...
			<g:form url="[resource:tipoContratoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${tipoContratoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
