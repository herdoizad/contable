...
<div class="flow-body">
    ...
    <g:each in="${caps}" var="c">
        <div class="panel panel-info" style="border-color:#2F4050 ">
            ...
            <div class="panel-body">
                <g:form action="saveCap_ajax" class=" frmC frmCap-${c.id}" enctype="multipart/form-data" >
    ...
    <div class="panel panel-info" style="border-color:#2F4050 ">
        ...
        <div class="panel-body">
            <g:form action="saveCap_ajax" class="frmC frmCap" enctype="multipart/form-data" >
                <input type="hidden" name="empleado.id" value="${empleado.id}">
                <div class="row fila">
                    <div class="col-md-1">
                        <label>Descripción:</label>
...
<script>
    ...
    var validator = $(".frmHoja").validate({
